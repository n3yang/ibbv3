...
class SpiderPyh extends SpiderBase
{
    ...
    public static function getCategoryIdByCategoryName($name)
    {
        $matches = [
            ...
            21 => ['儿童监护', '吸乳器', '产前产后'],
            20 => ['安全座椅'],
            19 => ['童鞋', '童装', '内外服饰', '套装', '舞蹈鞋', '靴子', '外套'],
            18 => ['婴儿推车', '餐椅摇椅', '家居家装', '伞车'],
            17 => ['LEGO积木拼插', '健身玩具', '益智玩具', '毛绒布艺', '毛绒/布艺', '模型玩具', 
                '乐器发声', '动漫相关', '高达/模型/机器人', '轨道/惯性玩具', '手办/人偶/BJD/摆件',
                '电子/发光玩具', '遥控车/飞机/船', '床铃/摇铃', '爬行毯/垫', '创意/减压', '芭比娃娃',
                '立体拼插'],
            14 => ['护肤', '洗护', '清洁', '洗浴', '日常护理'],
            11 => ['1段', '2段', '3段', '4段'],
            13 => ['布尿裤','XXXL', 'XXL', 'XL', 'M', 'L', 'S', 'NB/S', '婴儿尿裤'],
            15 => ['奶瓶奶嘴', '餐具', '碗盘叉勺'],
            12 => ['辅食', '肉松', '孕产奶粉', '成人奶粉', '米粉汤粥', 'DHA', '钙铁锌/维生素', '清火开胃'],
        ];
