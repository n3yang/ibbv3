...
class SpiderPyh extends SpiderBase
{
    ...
    public static function getCategoryIdByCategoryName($name)
    {
        $matches = [
            11 => ['1段', '2段', '3段', '4段', '特配奶粉'],
            12 => ['辅食', '肉松', '孕产奶粉', '成人奶粉', '米粉汤粥', 'DHA', '钙铁锌/维生素', '清火开胃', '果泥/果汁'],
            ...
            17 => ['LEGO积木拼插', '健身玩具', '益智玩具', '毛绒布艺', '毛绒/布艺', '模型玩具', 
                ...
                '立体拼插', '磁力玩具', '早教教具', '机器人', '车模/航模/建筑膜'],
            18 => ['婴儿推车', '餐椅摇椅', '家居家装', '伞车', '婴儿床'],
            19 => ['童鞋', '童装', '内外服饰', '运动户外', '运动鞋', '套装', '舞蹈鞋', '靴子', '外套', '休闲鞋'],
            20 => ['安全座椅'],
            21 => ['儿童监护', '吸乳器', '产前产后', '产后塑身'],
            22 => ['图书'],
        ];
