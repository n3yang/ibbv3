...
class SpiderBase extends \yii\base\Component
{
    ...
    public function getCategoryIdByOfferTitle($title)
    {
        $matches = [
            // 奶粉牛奶
            11  => ['奶粉', '婴儿配方奶粉', '爱他美', 'Abbott', '牛奶'],
            // 营养辅食
            12  => ['果汁泥', '果泥', '维生素D3', '辅食', '米糊', '维生素滴剂', '曲奇',
                '叶酸', '营养素', '童年时光', '钙尔奇', '星星泡芙', '补血', '补铁', '谷物棒',
            ...
            19  => ['太阳镜', '速干裤', '篮球服', '儿童午餐包', '书包', '溜冰鞋', '学步鞋', '童鞋', '儿童圆领内衣',
                '凉鞋', '连体衣', '长裤', '羽绒服', '童袜', '袜子', '婴儿服饰', '儿童纯棉内衣套装' ],
            // 安全座椅
            20  => ['安全座椅', 'Britax', '汽车座椅'],
            // 妈妈用品
