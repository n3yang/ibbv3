...
class SpiderBase extends \yii\base\Component
{
    ...
    public function getCategoryIdByOfferTitle($title)
    {
        $matches = [
            11  => ['奶粉', '婴儿配方奶粉', '爱他美'],
            12  => ['果汁泥', '果泥', '磨牙棒', '维生素D3', '辅食', '米糊', '维生素滴剂'],
            13  => ['拉拉裤', '纸尿裤', '尿不湿', '成长裤', '湿巾', '柔湿巾', '尿布', '纸巾'],
            14  => ['香皂', '指甲钳', '指甲剪', '洗衣液', '洗衣皂', '护唇膏', '牙刷', '洗脸盆', '宝宝金水', '护臀霜', '驱蚊', '清洁', '蚊香', '沐浴', '洗发', '修护膏'],
            15  => ['奶嘴', '奶瓶', '退热贴', '围兜', '套装食具', '咬胶', '牙胶', '脐贴', '儿童杯'],
            ...
            20  => ['安全座椅'],
            21  => ['婴儿背带', '乳头霜', 'Mavala Stop', '防溢乳垫', 'Bio-Oil', '吸乳器', '吸奶器', '暖奶器', '腰凳', '背带'],
            22  => ['翻翻书'],
            23  => ['肉', '月子茶', '亚麻籽油', '大叶红茶'],
            10  => ['促销活动'],
        ];
