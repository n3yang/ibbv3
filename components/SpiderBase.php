...
class SpiderBase extends \yii\base\Component
{
    ...
    public function getCategoryIdByOfferTitle($title)
    {
        $matches = [
            11  => ['奶粉', '婴儿配方奶粉', '爱他美'],
            12  => ['果汁泥', '果泥', '维生素D3', '辅食', '米糊', '维生素滴剂'],
            13  => ['拉拉裤', '纸尿裤', '尿不湿', '成长裤', '湿巾', '柔湿巾', '尿布', '纸巾'],
            14  => ['香皂', '指甲钳', '指甲剪', '洗衣液', '洗衣皂', '护唇膏', '牙刷', '洗脸盆', '宝宝金水', '护臀霜', '驱蚊', '清洁', '蚊香', '沐浴', '洗发', '修护膏', '防护霜'],
            15  => ['奶嘴', '奶瓶', '退热贴', '围兜', '套装食具', '咬胶', '牙胶', '脐贴', '儿童杯', '磨牙棒'],
            16  => ['睡袋', '花洒', '行李箱', '餐椅', '餐盘', '防护插排', '护肚脐围', '肚兜'],
            17  => ['儿童文具', '机器人', '火车', '玩具', '爬行垫', '游戏围栏', '手表', '梦想屋', '邦尼兔', '费雪', '澳贝','早教机', '画板', '电子琴'],
            18  => ['童车', '童床', '推车', '三轮车', '伞车', '婴儿床'],
